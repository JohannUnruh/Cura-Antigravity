...
export default function LecturesPage() {
    ...
    return (
        <ProtectedRoute requiredPermission="hasLectureAccess">
            <div className="animate-in fade-in duration-500 flex flex-col h-full space-y-6 max-w-5xl mx-auto w-full pb-10">
                    ...
                    {loading ? (
                        ...
                        lectures.map(item => (
                            <Card 
                                ...
                                className="border-white/50 dark:border-white/10 shadow-sm bg-white/40 dark:bg-slate-900/40 hover:shadow-md transition-shadow group cursor-pointer focus:outline-none focus:ring-2 focus:ring-amber-500/20"
                            >
                                <CardContent className="p-5 flex flex-col md:flex-row gap-4 justify-between md:items-center">
                                    ...
                                    <div className="flex gap-2 relative z-10">
                                        <button
                                            ...
                                            className="p-2 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-amber-500/20"
                                            title="Bearbeiten"
                                        >
                ...
                <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={selected ? "Vortrag bearbeiten" : "Neuer Vortrag"}>
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            <label htmlFor="topic" className="block text-sm font-bold text-gray-700 mb-1">Thema</label>
                            <input id="topic" type="text" required value={form.topic} onChange={e => setForm({ ...form, topic: e.target.value })}
                        ...
                        <div>
                            <label htmlFor="lectureType" className="block text-sm font-bold text-gray-700 mb-1">Vortragsart</label>
                            <select
                                id="lectureType"
                                title="Vortragsart"
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input id="church" type="text" name="lectureChurch" autoComplete="off" value={form.church} onChange={e => setForm({ ...form, church: e.target.value })}
                                    className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-amber-500/20"
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input id="durationInHours" type="text" inputMode="decimal" pattern="[0-9]*[.,]?[0-9]*" required value={durationStr}
                                    ...
                                    className={`w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-amber-500/20 ${
                            ...
                            <div>
                                <label htmlFor="prepTimeInHours" className="block text-sm font-medium text-gray-700 mb-1">Vorbereitungsstunden</label>
                        ...
                        {!selected && (
                            <div className="flex flex-col gap-3 px-4 py-3 bg-amber-50/30 rounded-xl border border-amber-200/50">
                                <label htmlFor="trackHours" className="flex items-center gap-3 cursor-pointer hover:bg-amber-50/50 transition-colors">
                                    <input
                                        id="trackHours"
                                        type="checkbox"
                                        checked={trackHours}
                                ...
                                {trackHours && (
                                    <>
                                        ...
                                        {isMultiDay && (
                                            <div className="pl-7 pt-2 border-t border-amber-200/30 space-y-3">
                                                                ...
                                                                <div key={key} className="flex items-center justify-between bg-white p-2 rounded-lg border border-gray-100">
                                                                    ...
                                                                    <div className="flex items-center gap-1.5">
                                                                        <input
                                                                            ...
                                                                            className="w-20 px-2 py-1 text-right border border-gray-200 rounded focus:ring-2 focus:ring-amber-500/20"
                                                                        />
