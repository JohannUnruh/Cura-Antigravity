            ...
            <ProtectedRoute>
                <div className="max-w-md mx-auto my-12 p-8 bg-white dark:bg-slate-900 rounded-2xl shadow-xl text-center border border-red-100 dark:border-red-950/30">
                    ...
                    <p className="text-gray-600 dark:text-slate-400 mb-8 text-sm">
                        Sie haben keine Berechtigung für den Bereich Familienhilfe (SPFH).
                    </p>
                    <Link href="/" className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-xl text-white bg-indigo-600 hover:bg-indigo-700 transition-colors w-full">
